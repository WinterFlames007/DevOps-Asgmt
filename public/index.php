...
$router->get('/reviews', 'PageController@reviews');
$router->post('/reviews', 'PageController@storeReview');
...
$router->get('/account/change-password', 'AccountController@changePasswordForm');
